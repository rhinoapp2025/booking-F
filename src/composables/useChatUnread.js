...
export function useChatUnread() {
  ...
  const isAdminForHotel = computed(() => auth.canAccessHotelAdmin(hotelSlug.value))
  ...
  async function refresh() {
    ...
    try {
      const url = isAdminForHotel.value
        ? `/api/admin/${hotelSlug.value}/chat/unread-count`
        : `/api/chat/${hotelSlug.value}/unread-count`
  ...
  watch([hotelSlug, isAdminForHotel], refresh)
